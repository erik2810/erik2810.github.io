...
This post outlines the article I am preparing for submission to JHEP, *Interacting Vertex Operators in Euclidean AdS₂* ([read the abstract](/assets/pdf/interacting-vertex-operators-eads2-abstract.pdf)). It extends the free-field analysis of my [thesis](/blog/sine-gordon-ads-cft/) to the interacting theory and settles a question the thesis left open.
...
is finite. The renormalization scale $M$ is arbitrary, and tracking it gives a beta function and the renormalized anomalous dimension $\Delta_1 = \Delta + \lambda\,\Delta^{(1)} + \mathcal{O}(\lambda^2)$. I work out the scheme dependence directly and compare the curved-space structure with the flat-space Sine-Gordon result.
...
The numerical side of this program is implemented in [DiffQFT](https://erik2810.github.io/DiffQFT/): differentiable Witten-diagram integration, neural surrogates, and a PINN for the Klein-Gordon equation.
